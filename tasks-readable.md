...
| Sprint | Tasks | Status |
|---|---|---|
| Week 1 (Feb 10–16) | S1-001 → S1-005, S2-001 → S2-002, S3-001 | ⬜ Not started |
| Week 2 (Feb 17–23) | S3-002 → S3-003, S4-001 → S4-002, S5-001 → S5-003, S6-001 | ⬜ Not started |
| Week 3 (Feb 24–Mar 2) | S6-002 → S6-003, S7-001 → S7-004, S8-001 → S8-002 | ⬜ Not started |
| Week 4 (Mar 3–9) | S9-001 → S9-002, S10-001 → S10-002, S14-001 → S14-002 | ⬜ Not started |
| Week 5 (Mar 10–15) | Demo recording, polish, submission | ⬜ Not started |

**Total tasks: 27** | **P0: 21** | **P1: 6**
...
- **Priority:** P0 | **System:** Scaffold
- **What:** Bicep for all Azure resources: Cosmos DB (7 containers), Blob, SignalR, Key Vault, Container Apps, Static Web Apps, Log Analytics
...
- **Priority:** P0 | **System:** Scaffold
- **What:** SignalR hub on API, client hook on Web, test echo channel
...
## Week 4: Governance + Delta (Mar 3–9)
