	...
	theme: {
		extend: {
			animation: {
				...
				"modal-blast": "modal-blast 0.35s ease-out forwards",
				"spawn-agent": "spawn-agent 0.4s ease-out forwards",
				"launch-ripple": "launch-ripple 0.6s ease-out forwards",
				"shake-x": "shake-x 0.5s ease-out",
				...
				"reinforcement-arrive": "reinforcement-arrive 0.5s ease-out forwards",
